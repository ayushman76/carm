...
for(var i in car01_arr){
      document.querySelector('.Lakh01>.crouselitem01>.product').innerHTML+=`
...
for(var i in car02_arr){
      document.querySelector('.Lakh02>.crouselitem01>.product').innerHTML+=`
...
for(var i in car03_arr){
      document.querySelector('.Lakh03>.crouselitem01>.product').innerHTML+=`
...
for(var i in trust_arr){
      document.querySelector('.Trusted>.crouselitem01>.product').innerHTML+=`
